...
public class PreCheckHelper {
    ...
    public static <T> T removeBlank(T object) {
        if (object == null) {
            ...
            clt.clear();
            for (Object obj : array) {
                obj = (obj instanceof String) && StringUtils.isBlank((CharSequence) obj) ? null : obj;
                if (obj != null) {
                    clt.add(obj);
                }
            }
            ...
            for (Object key : array) {
                ...
                obj = (obj instanceof String) && StringUtils.isBlank((CharSequence) obj) ? null : obj;
                key = (key instanceof String) && StringUtils.isBlank((CharSequence) key) ? null : key;
                if (!(key == null || map.get(key) == null)) {
                    map.put(key, obj);
                }
            }
    ...
    public static <T> T trimAndRemoveBlank(T object) {
        if (object == null) {
            ...
            clt.clear();
            for (Object obj : array) {
                obj = (obj instanceof String) ? obj.toString().trim() : obj;
                obj = (obj instanceof String) && StringUtils.isBlank((CharSequence) obj) ? null : obj;
                if (obj != null) {
                    clt.add(obj);
                }
            ...
            for (Object key : array) {
                Object obj = map.remove(key);
                key = (key instanceof String) ? (((String) key).trim()) : key;
                key = (key instanceof String) && StringUtils.isBlank((String) key) ? null : key;
                obj = (obj instanceof String) ? (((String) obj).trim()) : obj;
                obj = (obj instanceof String) && StringUtils.isBlank((String) obj) ? null : obj;
                if (!(key == null || map.get(key) == null)) {
                    map.put(key, obj);
                }
            }
