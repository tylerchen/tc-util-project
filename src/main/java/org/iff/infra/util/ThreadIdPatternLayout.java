/*******************************************************************************
 * Copyright (c) May 6, 2016 @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a>.
 * All rights reserved.
 *
 * Contributors:
 ...
 * @since May 6, 2016
 */
public class ThreadIdPatternLayout extends Layout {
	...
	*/
	public String format(LoggingEvent event) {
		...
		if (sbuf.capacity() > MAX_CAPACITY + 40) {
			sbuf = new StringBuffer(BUF_SIZE);
		} else {
			sbuf.setLength(0);
		}

		sbuf.append('[').append(getTraceId()).append(']');
