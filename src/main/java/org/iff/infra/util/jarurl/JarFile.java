...
package org.iff.infra.util.jarurl;
...
import org.iff.infra.util.jarurl.RandomAccessData.ResourceAccess;
...
public class JarFile extends java.util.jar.JarFile {
	...
	void setupEntryCertificates(JarEntry entry) {
		...
		try {
			try (JarInputStream inputStream = new JarInputStream(getData().getInputStream(ResourceAccess.ONCE))) {
