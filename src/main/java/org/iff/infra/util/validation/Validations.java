...
public class Validations {
	...
	public static void minLength(Errors e, String field, int minLength, String errorCode) {
		minLength(e, field, minLength, errorCode, null, null);
	}

	public static void minLength(Errors e, String field, int minLength, String errorCode, String defaultMessage) {
		minLength(e, field, minLength, errorCode, null, defaultMessage);
	}

	public static void minLength(Errors e, String field, int minLength, String errorCode, Object[] errorArgs,
	...
	public static void maxLength(Errors e, String field, int maxLength, String errorCode) {
		maxLength(e, field, maxLength, errorCode, null, null);
	}

	public static void maxLength(Errors e, String field, int maxLength, String errorCode, String defaultMessage) {
		maxLength(e, field, maxLength, errorCode, null, defaultMessage);
	}

	public static void maxLength(Errors e, String field, int maxLength, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void rangeLength(Errors e, String field, int minLength, int maxLength, String errorCode) {
	...
	public static void min(Errors e, String field, Number min, String errorCode) {
		min(e, field, min, errorCode, null, null);
	}

	public static void min(Errors e, String field, Number min, String errorCode, String defaultMessage) {
		min(e, field, min, errorCode, null, defaultMessage);
	}

	public static void min(Errors e, String field, Number min, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void max(Errors e, String field, Number max, String errorCode) {
		max(e, field, max, errorCode, null, null);
	}

	public static void max(Errors e, String field, Number max, String errorCode, String defaultMessage) {
		max(e, field, max, errorCode, null, defaultMessage);
	}

	public static void max(Errors e, String field, Number max, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void range(Errors e, String field, Number min, Number max, String errorCode) {
		range(e, field, min, max, errorCode, null, null);
	}

	public static void range(Errors e, String field, Number min, Number max, String errorCode, String defaultMessage) {
		range(e, field, min, max, errorCode, null, defaultMessage);
	}

	public static void range(Errors e, String field, Number min, Number max, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void date(Errors e, String field, String pattern, String errorCode) {
		date(e, field, pattern, errorCode, null, null);
	}

	public static void date(Errors e, String field, String pattern, String errorCode, String defaultMessage) {
		date(e, field, pattern, errorCode, null, defaultMessage);
	}

	public static void date(Errors e, String field, String pattern, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void zipcode(Errors e, String field, String errorCode, String defaultMessage) {
		zipcode(e, field, errorCode, null, defaultMessage);
	}

	public static void zipcode(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
	...
	public static void idcard(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
		if (!(ValidationMethods.idcard(e.getFieldValue(field)))) {
			e.rejectValue(field, errorCode, errorArgs, defaultMessage);
		}
	}

	public static void pattern(Errors e, String field, String regex, String errorCode) {
		pattern(e, field, regex, errorCode, null, null);
	}

	public static void pattern(Errors e, String field, String regex, String errorCode, String defaultMessage) {
		pattern(e, field, regex, errorCode, null, defaultMessage);
	}

	public static void pattern(Errors e, String field, String regex, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void extension(Errors e, String field, List<String> extensions, String errorCode) {
	...
	public static void extension(Errors e, String field, List<String> extensions, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void chinese(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
	...
	public static void mobile(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
	...
	public static void tel(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
	...
	public static void lettersOnly(Errors e, String field, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void alphaNumeric(Errors e, String field, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void time(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
		if (!(ValidationMethods.time(e.getFieldValue(field)))) {
			e.rejectValue(field, errorCode, errorArgs, defaultMessage);
		}
	}

	public static void equalTo(Errors e, String field, String otherField, String errorCode) {
		equalTo(e, field, otherField, errorCode, null, null);
	}

	public static void equalTo(Errors e, String field, String otherField, String errorCode, String defaultMessage) {
		equalTo(e, field, otherField, errorCode, null, defaultMessage);
	}

	public static void equalTo(Errors e, String field, String otherField, String errorCode, Object[] errorArgs,
			String defaultMessage) {
	...
	public static void digits(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
	...
	public static void number(Errors e, String field, String errorCode, Object[] errorArgs, String defaultMessage) {
