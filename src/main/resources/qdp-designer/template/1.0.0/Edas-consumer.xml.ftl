...
<#list project as module>
	...
	<hsf:consumer id="${class?uncap_first}Application"
...
<@filewriter type="xml" basedir=projectdir(root.projectName)+"/src/main/resources/META-INF/spring-edas-consumer/"
	name="edas-consumer-system.xml">
	<@edas/>
</@filewriter>
