 ...
 ******************************************************************************/
package ${appimplPackage(package,module,func.packageName)};
 ...
 */
@Named("${class?uncap_first}Application")
@Transactional
public class ${class}ApplicationImpl implements ${class}Application {
	 ...
	 * @return ${class}VO
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#get${class}(${class}VO)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public ${class}VO get${class}(${class}VO vo) {
		${class} ${class?uncap_first} = BeanHelper.copyProperties(${class}.class, vo);
		${class?uncap_first} = ${class}.get(${class?uncap_first});
		return BeanHelper.copyProperties(${class}VO.class, ${class?uncap_first});
	}
	...
	public ${class}VO get${class}ById(${field.javaType} ${javaFieldName}){
		${class} ${class?uncap_first} = ${class}.get(${javaFieldName});
		return BeanHelper.copyProperties(${class}VO.class, ${class?uncap_first});
	}
	 ...
	 * @return Page
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#pageFind${class}(${class}VO, Page)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public Page pageFind${class}(${class}VO vo, Page page) {
		...
		<#if table.formType=='tree'><#local menuIndex={}/><#list columns as field><#if field.field=='MENU_INDEX'><#local menuIndex=field/></#if></#list>
			<#if menuIndex?has_content>
		// 添加树节点的排序
		page.addAscOrderBy("menuIndex");<#--树的特有操作-->
			</#if>
		</#if>
		page = Dao.queryPage("${class}.pageFind${class}", MapHelper.toMap("page", page, "vo", vo));
		return page.toPage(${class}VO.class);
	}
	 ...
	 * @return Page
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#pageFind${class}Map(${class}VO, Page)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public Page pageFind${class}Map(${class}VO vo, Page page) {
		...
		page = Dao.queryPage("${class}.pageFind${class}Map", MapHelper.toMap("page", page, "vo", vo));
		return page.toPage(${class}VO.class);
	}
	 ...
	 * @return ${class}VO
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#add${class}(${class}VO)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public ${class}VO add${class}(${class}VO vo) {
		...
		// 关联中间表设值: 分配${refFunc.name}，当值为null时，表示不更新该字段，如果设置为长度为0，则表示清空所有分配值。
		if(vo.get${javaField(field.field)?cap_first}() != null) {
			${class?uncap_first}.assign${refClass}ByIds(StringUtils.split(vo.get${javaField(field.field)?cap_first}(), ','));
		}
		</#if></#list>
		${class}VO ${class?uncap_first}VO = BeanHelper.copyProperties(${class}VO.class, ${class?uncap_first});
		return ${class?uncap_first}VO;
	}
	 ...
	 * @return ${class}VO
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#update${class}(${class}VO)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	 ...
	 * @param vo conditions.
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#remove${class}(${class}VO)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public void remove${class}(${class}VO vo) {
		${class} ${class?uncap_first} = BeanHelper.copyProperties(${class}.class, vo);
		${class}.remove(${class?uncap_first});
	}
	...
	public void remove${class}ById(${field.javaType} id) {
		if( id instanceof String ) {
			${class}.remove(StringUtils.split(id, ','));
		} else {
			${class}.remove(id);
		}
	}
	...
	public ${class}VO getBy${javaFieldName?cap_first}(${field.javaType} ${javaFieldName}) {
		${class} ${class?uncap_first} = ${class}.getBy${javaFieldName?cap_first}(${javaFieldName});
		return BeanHelper.copyProperties(${class}VO.class, ${class?uncap_first});
	}
	 ...
	 * @return Page
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#pageFindAssign${refClass}(${class}VO, Page)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
	public Page pageFindAssign${refClass}(${class}VO vo, Page page) {
		page = Dao.queryPage("${class}.pageFind${refClass}By${midClass}Map", MapHelper.toMap("page", Page.notNullPage(page), "vo", vo));
		return page.toPage(${refClass}VO.class);
	}
	...
	public void assign${refClass}(${class}VO vo) {
		${class} domain = BeanHelper.copyProperties(${class}.class, vo);
		domain.assign${refClass}ByIds(StringUtils.split(vo.get${javaField(field.field)?cap_first}(), ","));
	}
	</#if></#list>
	 ...
	 * (non-Javadoc)
	 * @see ${appPackage(package,module,func.packageName)}.${class}Application#${javaField(columnField(item.fileName))}(${javaClass(columnField(item.fileName),'')?cap_first}VO, Page)
	 * @author <a href="mailto:iffiff1@gmail.com">Tyler Chen</a> 
	 * @since ${date}
	 * auto generate by qdp v3.0.
	 */
		...
		<#list func.children as item>
			<#if item.type=='page' && item.name=='index' && (item.formType=='grid' || item.formType=='tree')>
				...
				<@filewriter type="java" basedir=projectdir(root.projectName)+"/src/main/java/"
					name="${appimplPackage(package, moduleName,func.packageName)}.${class}ApplicationImpl.java">
